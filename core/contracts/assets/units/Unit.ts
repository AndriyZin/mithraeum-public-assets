...
export interface UnitInterface extends utils.Interface {
  functions: {
    "ARMY_ASSET_TYPE()": FunctionFragment;
    ...
    "worldUnitName()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "ARMY_ASSET_TYPE",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "worldUnitName",
    values?: undefined
  ): string;
...
export interface Unit extends BaseContract {
  ...
  functions: {
    ARMY_ASSET_TYPE(overrides?: CallOverrides): Promise<[string]>;
    ...
    worldUnitName(overrides?: CallOverrides): Promise<[string]>;
  };
  ...
  estimateGas: {
    ARMY_ASSET_TYPE(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    worldUnitName(overrides?: CallOverrides): Promise<BigNumber>;
  };

  populateTransaction: {
    ARMY_ASSET_TYPE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    worldUnitName(overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
