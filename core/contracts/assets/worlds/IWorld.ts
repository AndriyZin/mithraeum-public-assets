...
export interface IWorld extends BaseContract {
  ...
  functions: {
    ...
    resourcesMap(name: string, overrides?: CallOverrides): Promise<[string]>;
    ...
    settlements(adr: string, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    unitsMap(name: string, overrides?: CallOverrides): Promise<[string]>;
    ...
    userTier(userAddress: string, overrides?: CallOverrides): Promise<[number]>;
  ...
  continents(index: BigNumberish, overrides?: CallOverrides): Promise<string>;
  ...
  worldAssets(worldAsset: string, overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    resourcesMap(name: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    unitsMap(name: string, overrides?: CallOverrides): Promise<BigNumber>;
