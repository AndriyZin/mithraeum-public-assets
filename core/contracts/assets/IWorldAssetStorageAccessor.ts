...
export interface IWorldAssetStorageAccessorInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "assetName" | "assetType"
  ): FunctionFragment;
...
export interface IWorldAssetStorageAccessor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IWorldAssetStorageAccessorInterface;
