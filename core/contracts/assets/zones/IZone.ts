...
export interface IZoneInterface extends utils.Interface {
  functions: {
...
export interface IZone extends BaseContract {
  ...
  functions: {
    ...
    unitsAmmMap(unitName: string, overrides?: CallOverrides): Promise<[string]>;
  };
  ...
  coordinatesX(index: BigNumberish, overrides?: CallOverrides): Promise<number>;

  coordinatesY(index: BigNumberish, overrides?: CallOverrides): Promise<number>;
  ...
  tileTypes(index: BigNumberish, overrides?: CallOverrides): Promise<number>;
