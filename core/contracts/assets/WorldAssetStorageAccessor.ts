...
export interface WorldAssetStorageAccessorInterface extends utils.Interface {
  functions: {
...
export interface WorldAssetStorageAccessor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WorldAssetStorageAccessorInterface;
