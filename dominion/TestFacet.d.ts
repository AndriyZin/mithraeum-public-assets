...
interface TestFacetInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "a", values: [string]): string;
...
export class TestFacet extends BaseContract {
  ...
  functions: {
    ...
    a(building: string, overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    a(building: string, overrides?: CallOverrides): Promise<BigNumber>;
