...
interface SubjectsFacetBasicInterface extends ethers.utils.Interface {
  functions: {
...
export class SubjectsFacetBasic extends BaseContract {
  ...
  interface: SubjectsFacetBasicInterface;
