...
interface ManagerFacetBasicInterface extends ethers.utils.Interface {
  functions: {
...
export class ManagerFacetBasic extends BaseContract {
  ...
  interface: ManagerFacetBasicInterface;
