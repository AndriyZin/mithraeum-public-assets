...
interface DistributionFacetBasicInterface extends ethers.utils.Interface {
  functions: {
...
export class DistributionFacetBasic extends BaseContract {
  ...
  interface: DistributionFacetBasicInterface;
